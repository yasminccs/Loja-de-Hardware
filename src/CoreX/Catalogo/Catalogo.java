...
public class Catalogo extends javax.swing.JFrame {
    ...
    public static void exibirProdutos(Carrinho carrinho){
        ...
        CatalogoForm.ErroLabel.setVisible(false);
        ...
        CatalogoForm.ListaProdutos.addListSelectionListener(new ListSelectionListener(){
            @Override
            public void valueChanged(ListSelectionEvent e){
                if (!e.getValueIsAdjusting()){
                    if(produtoJaNoCarrinho(CatalogoForm.ListaProdutos.getSelectedIndex(), carrinho)){
                        CatalogoForm.ErroLabel.setVisible(true);
                    }
                    else{
                        CatalogoForm.dispose();
                        ExibirProdutoForm ExibirProdutoForm = new ExibirProdutoForm();
                        ExibirProdutoForm.setListaProdutos(CatalogoForm.ListaProdutos.getSelectedIndex(), produtos);
                        ExibirProdutoForm.setCarrinho(carrinho);
                        ExibirProdutoForm.exibirProduto();
                        ExibirProdutoForm.setVisible(true);
                        ExibirProdutoForm.setLocationRelativeTo(null);
                    }
                }
            }
        });
        CatalogoForm.ListaProdutos.setModel(new javax.swing.AbstractListModel<String>() {
            public int getSize() { return itens.size(); }
            public String getElementAt(int i) { return itens.get(i); }
        });
        CatalogoForm.ListaProdutos.setCellRenderer(new RenderizadorListaMultilinha());
        
        CatalogoForm.setLocationRelativeTo(null);
    ...
    public static boolean produtoJaNoCarrinho(int codigo, Carrinho carrinho) {
