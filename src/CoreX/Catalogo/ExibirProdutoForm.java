...
public class ExibirProdutoForm extends javax.swing.JFrame {

    public ExibirProdutoForm() {
        initComponents();
    }
    ...
    private void AddCarrinhoBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddCarrinhoBtnActionPerformed
        ...
        }else if(!Catalogo.produtoJaNoCarrinho(indexProduto,carrinho)){
    ...
    public void setCarrinho(Carrinho carrinhoNovo){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExibirProdutoForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        //</editor-fold>
        ExibirProdutoForm form = new ExibirProdutoForm();
